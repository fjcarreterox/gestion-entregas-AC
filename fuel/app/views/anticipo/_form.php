	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Banco', 'idbanco', array('class'=>'control-label')); ?>
				...
				<?php echo Form::select('idbanco', '',$bancos_ops, array('class' => 'col-md-4 form-control', 'placeholder'=>'Banco donde se cobrará el anticipo')); ?>
		...
		<div class="form-group">
			...
			<?php echo Form::submit('submit', $label, array('class' => 'btn btn-primary')); ?>
        </div>
	</fieldset>
<?php echo Form::close(); ?>