...
<br/>
<p>Durante la presente campaña hay registrados <strong><?php echo count($proveedors);?> proveedores.</strong></p>
<br/>
<p>
			...
			<td>
				<div class="btn-toolbar">
					<div class="btn-group">
                        ...
                        <?php echo Html::anchor('proveedor/edit/'.$item->id, '<span class="glyphicon glyphicon-pencil"></span> Editar', array('class' => 'btn btn-small btn-success')); ?>
                        ...
                        <?php echo Html::anchor('proveedor/delete/'.$item->id, '<span class="glyphicon glyphicon-trash"></span> Borrar', array('class' => 'btn btn-small btn-danger', 'onclick' => "return confirm('¿Estás seguro de esto? El borrado de un proveedor conllevará al borrado de sus facturas, anticipos, albaranes y entregas asociadas.')")); ?>
                    </div>
				</div>
			</td>
		</tr>
